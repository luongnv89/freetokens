...
type StructuredDataProps =
  ...
  | { page: "detail"; index: OffersIndex; slug: string; detail?: OfferDetail | null; baseUrl?: string }
...
export function StructuredData(props: StructuredDataProps) {
  ...
  if (props.page === "home") {
    ...
    pageNode = {
      ...
      description: "Reference archive of expired free AI credit offers, kept newest-first with their original terms.",
      isPartOf: { "@id": `${base}/#website` },
      inLanguage: "en",
    }
    if (offers.length > 0) {
    ...
    pageNode = {
      ...
      description: "What Free AI Credits is, how the listings are verified, and what the numbers mean.",
      isPartOf: { "@id": `${base}/#website` },
      inLanguage: "en",
    }
    ...
    pageNode = {
      ...
      description: "How the Free AI Credits site handles data: consent-gated anonymized analytics, no forms, no personal data storage.",
      isPartOf: { "@id": `${base}/#website` },
      inLanguage: "en",
    }
